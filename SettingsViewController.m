...
- (void)showButtonAlert {
    if ([MFMailComposeViewController canSendMail]) {
        ...
        [[UIAlertView alloc] initWithTitle:@"Emailed Not Enabled"
                                   message:@"Please enable your enable email "
         @"through the default mail app"
                                  delegate:nil
...
- (void)showTermsConditions {
    SVWebViewController *webViewController = [[SVWebViewController alloc]
                                              initWithAddress:@"http://klinik.io/terms.html"];
    [self.navigationController pushViewController:webViewController animated:YES];
}

- (void)showPrivacyPolicy {
    SVWebViewController *webViewController = [[SVWebViewController alloc]
                                              initWithAddress:@"http://klinik.io/privacy.html"];
    [self.navigationController pushViewController:webViewController animated:YES];
}
