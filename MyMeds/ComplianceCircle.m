...
@implementation ComplianceCircle
...
- (void)addCircleLayerWithType:(NSInteger)type {
    ...
    switch (type) {
        case VMMakeLocationTop:
            ...
            [path1 moveToPoint:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                           -screenHeight)];
            ...
            [path2 addLineToPoint:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                              -screenHeight)];
            break;
            
        case VMMakeLocationBottom:
            radius = CGRectGetWidth(self.bounds) / 2 - lineWidth / 2;
            rect = CGRectMake(CGRectGetWidth(self.bounds) - lineWidth / 2,
                              CGRectGetHeight(self.bounds) - lineWidth / 2, radius * -2,
                              radius * -2);
            
            [path1 moveToPoint:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                           +screenHeight)];
            [path1 addLineToPoint:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                              CGRectGetHeight(self.bounds) - 1)];
            
            [path2 moveToPoint:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                           CGRectGetHeight(self.bounds) - 1)];
            [path2 addLineToPoint:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                              +screenHeight)];
            break;
    ...
    self.property = [[UILabel alloc]
                     initWithFrame:CGRectMake(10, CGRectGetWidth(self.bounds) / 4,
                                              CGRectGetWidth(self.bounds) - 20, 20)];
    ...
    self.value = [[UILabel alloc]
                  initWithFrame:CGRectMake(10, CGRectGetWidth(self.bounds) / 4 + 20,
...
- (void)setIconButton:(UIImage *)icon
    ...
    [self.imgIcon setFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds) -
    ...
    switch (type) {
        case VMMakeLocationTop:
            [self.imgIcon setCenter:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                                CGRectGetHeight(self.bounds) / 2 - 5)];
            break;
        case VMMakeLocationBottom:
            [self.imgIcon setCenter:CGPointMake(CGRectGetWidth(self.bounds) / 2,
                                                CGRectGetHeight(self.bounds) / 2 + 5)];
...
- (void)buildButton {
    ...
    swipeLine.timingFunction = [CAMediaTimingFunction
...
- (void)animationLineBottomToHide {
    ...
    swipeLine1.timingFunction = [CAMediaTimingFunction
                                 functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
...
- (void)animationLineCircle {
    ...
    [UIView animateWithDuration:0.5
                     ...
                     completion:^(BOOL finished){
                         //        CABasicAnimation *fillColorAnimation = [CABasicAnimation
                         //        animationWithKeyPath:@"fillColor"];
                         //        fillColorAnimation.duration = 0.5f;
                         //        fillColorAnimation.fromValue = (id)[[UIColor clearColor]
                         //        CGColor];
                         //        fillColorAnimation.toValue =
                         //        (id)self.circleLayer.strokeColor;
                         //        [self.circleLayer addAnimation:fillColorAnimation
                         //        forKey:@"fillColor"];
                         //        [self.circleLayer
                         //        setFillColor:self.circleLayer.strokeColor];
                     }];
}
