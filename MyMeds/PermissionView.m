...
- (instancetype)init {
    ...
    view = [[UIView alloc]
            initWithFrame:CGRectMake(width / 2 - 140, height / 2 - 210, 280, 400)];
    ...
    UICustomButton *cancel =
    [[UICustomButton alloc] initWithFrame:CGRectMake(0, 356, 120, 43)];
    ...
    // UIButton *allow = [[UIButton alloc] initWithFrame:CGRectMake(121, 356, 159,
    // 43)];
    UICustomButton *allow =
    [[UICustomButton alloc] initWithFrame:CGRectMake(0, 356, 280, 43)];
    ...
    UITextView *message =
    [[UITextView alloc] initWithFrame:CGRectMake(10, 40, 260, 60)];
    message.text = @"We suggest allowing notifications. This allows us to send "
    @"you reminders & gives you better control over your meds!";
    ...
    [[UIImageView alloc] initWithFrame:CGRectMake(10, 110, 260, 160)];
    screenImageView.image = screenImage;
    
    UIImage *swipeImage = [UIImage imageNamed:@"swipe.png"];
    UIImageView *swipeImageView =
    [[UIImageView alloc] initWithFrame:CGRectMake(10, 275, 260, 73)];
...
- (void)setHighlighted:(BOOL)highlighted {
    ...
    if (highlighted) {
        self.backgroundColor =
        [UIColor colorWithHue:0.0 saturation:0.0 brightness:0.9 alpha:1.0];
...
+ (BOOL)getValue {
    ...
    BOOL remoteNotificationsEnabled = false, noneEnabled, alertsEnabled,
    badgesEnabled, soundsEnabled;
    ...
    if ([[UIApplication sharedApplication]
        ...
        badgesEnabled =
        userNotificationSettings.types & UIUserNotificationTypeBadge;
        soundsEnabled =
        userNotificationSettings.types & UIUserNotificationTypeSound;
    }
