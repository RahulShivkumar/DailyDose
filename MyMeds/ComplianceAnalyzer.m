...
- (void)animateViews{
    ...
    circleView1 = [[ComplianceCircle alloc] initWithFrame:CGRectMake(0, 0, 120, 120)];
    [circleView1 addCircleLayerWithType:VMMakeLocationTop];
    circleView1.strokeColor = kInfoColor;
    circleView1.center = CGPointMake(CGRectGetWidth(self.bounds)/4, CGRectGetHeight(self.bounds) * 2/3);
    [circleView1 setIconButton:[UIImage imageNamed:@"Layer 14.png"] withType:VMMakeLocationTop withColor:kInfoColor];
    [circleView1 setLineWidthValue:1];
    [circleView1 setValue:[values objectForKey:@"missed"] andProperty:@"Missed Meds" andTextColor:kInfoColor];
    [self addSubview:circleView1];
    
    circleView2 = [[ComplianceCircle alloc] initWithFrame:CGRectMake(0, 0, 120, 120)];
    [circleView2 addCircleLayerWithType:VMMakeLocationBottom];
    circleView2.strokeColor = kDelayColor;
    circleView2.center = CGPointMake(CGRectGetWidth(self.bounds)/2, CGRectGetHeight(self.bounds)/3);
    [circleView2 setIconButton:[UIImage imageNamed:@"Layer 15.png"] withType:VMMakeLocationBottom withColor:kDelayColor];
    [circleView2 setLineWidthValue:1];
    [circleView2 setValue:[values objectForKey:@"delayed"]  andProperty:@"Delayed Meds" andTextColor:kDelayColor];
    [self addSubview:circleView2];
    
    
    circleView3 = [[ComplianceCircle alloc] initWithFrame:CGRectMake(0, 0, 120, 120)];
    [circleView3 addCircleLayerWithType:VMMakeLocationTop];
    circleView3.strokeColor = kDoneColor;
    circleView3.center = CGPointMake(CGRectGetWidth(self.bounds) * 3/4, CGRectGetHeight(self.bounds) * 2/3);
    [circleView3 setIconButton:[UIImage imageNamed:@"Layer 16.png"] withType:VMMakeLocationTop withColor:kDoneColor];
    [circleView3 setLineWidthValue:1];
    [circleView3 setValue:[values objectForKey:@"compliance"]  andProperty:@"Compliance %" andTextColor:kDoneColor];
