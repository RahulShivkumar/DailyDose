...
- (void)animateViews{
    ...
    circleView1.center = CGPointMake(CGRectGetWidth(self.bounds)/2 - 100, CGRectGetHeight(self.bounds)/2 + 60);
    ...
    circleView2.center = CGPointMake(CGRectGetWidth(self.bounds)/2, CGRectGetHeight(self.bounds)/2 - 80);
    ...
    circleView3.center = CGPointMake(CGRectGetWidth(self.bounds)/2 + 100, CGRectGetHeight(self.bounds)/2 + 60);
