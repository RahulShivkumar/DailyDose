...
- (void)walkthroughDidScrollToPosition:(CGFloat)position
    ...
    self.titleLabel.layer.transform =
    CATransform3DRotate(tr, (CGFloat)M_PI * (1.0 - offset), 1, 1, 1);
    self.textLabel.layer.transform =
    CATransform3DRotate(tr, (CGFloat)M_PI * (1.0 - offset), 1, 1, 1);
    ...
    CATransform3DTranslate(tr, 0, (1.0 - tmpOffset) * 200, 0);
}
