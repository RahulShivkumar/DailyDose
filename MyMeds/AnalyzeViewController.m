...
- (void)viewDidLoad {
    ...
    // [self.view setBackgroundColor:[UIColor colorWithRed:122/255.0 green:0/255.0
...
- (void)setupViews {
    ...
    graphTitle = [[UILabel alloc]
                  initWithFrame:CGRectMake(17, 15, [Constants window_width], 20)];
    ...
    UIView *graphView = [[UIView alloc]
                         initWithFrame:CGRectMake(5, 40, [Constants window_width] - 10,
                                                  [Constants window_height] * 0.33)];
    ...
    self.complianceGraph = [[BEMSimpleLineGraphView alloc]
                            initWithFrame:CGRectMake(5, 5, [Constants window_width] - 20,
                                                     [Constants window_height] * 0.33 - 10)];
    
    // Apply the gradient to the bottom portion of the graph
    self.complianceGraph.gradientBottom = CGGradientCreateWithColorComponents(
...
- (void)setupData {
    ...
    tmt = [[TopMedsTable alloc]
           initWithFrame:CGRectMake(0, [Constants window_height] * 0.33 + 55,
                                    [Constants window_width],
                                    [Constants window_height] * 0.62 - 129)
           andData:topMeds];
...
didTouchGraphWithClosestIndex:(NSInteger)index {
    // Here you could change the text of a UILabel with the value of the closest
    // index for example.
}
